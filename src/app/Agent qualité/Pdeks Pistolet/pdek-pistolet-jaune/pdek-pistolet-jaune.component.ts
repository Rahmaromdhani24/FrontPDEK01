...
@Component({
  selector: 'app-pdek-pistolet-jaune',
  standalone: true,
  imports: [
    ChartModule,
    MatCardModule,
...
export class PdekPistoletJauneComponent implements OnInit {

   constructor(private pistoletGeneralService: PistoletGeneralService , private route: ActivatedRoute){}
